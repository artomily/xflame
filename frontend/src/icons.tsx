// Shared inline SVG icons — used by App.tsx (tabs + roadmap) and Landing.tsx.
...
export function AutoTriggerIcon() {
  return (
...
export function AccountSafetyIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
